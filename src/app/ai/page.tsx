  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'مرحباً! أنا Q8 NeX DeV - المساعد الذكي الكويتي. كيف يمكنني مساعدتك اليوم؟ يمكنني الإجابة عن الخدمات، الأسعار، وأي استفسارات أخرى.',
      timestamp: new Date(),
    },
  ]);
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            {t(
              'المساعد الذكي الكويتي - مدعوم بالذكاء الاصطناعي',
              'Kuwaiti AI Assistant - Powered by AI'
            )}
          </p>
          <Link href="/">
